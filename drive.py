...
def downsize(image):
    ...
    #TODO : remplacer par :,:]
    random_crop = image[horizon:bonnet, col_start:col_end, :]
    CROPPED_DIM = 64
...
#     image_array = downsize(image_array)
...
#     throttle = 0.2
#     print(f"sta: {steering_angle:.3f}  |  throttle: {throttle:.2f}")
#
...
def telemetry(sid, data):
    if data:
        ...
        print(f"steer: {steering_angle:.3f}  |  throttle: {throttle:.3f}")
